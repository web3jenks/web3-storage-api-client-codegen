...
class FailureError(ModelNormal):
    ...
    def _from_openapi_data(cls, reason, *args, **kwargs):  # noqa: E501
        """FailureError - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            details (str): Optional, longer description of the error; may include UUID of transaction for support, links to documentation etc. [optional]  # noqa: E501
        """
