...
class Delegates(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Delegates - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): List of multiaddrs designated by pinning service for transferring any new data from external peers.  # noqa: E501

        Keyword Args:
            value ([str]): List of multiaddrs designated by pinning service for transferring any new data from external peers.  # noqa: E501
