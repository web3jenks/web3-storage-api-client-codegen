...
class Pin(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            peer_id (str): Libp2p peer ID of the node pinning the data.. [optional]  # noqa: E501
            peer_name (str): Human readable name for the peer pinning the data.. [optional]  # noqa: E501
            region (str): Approximate geographical region of the node pinning the data.. [optional]  # noqa: E501
            status (str): [optional]  # noqa: E501
            updated (datetime): This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format: YYYY-MM-DDTHH:MM:SSZ.. [optional]  # noqa: E501
        """
