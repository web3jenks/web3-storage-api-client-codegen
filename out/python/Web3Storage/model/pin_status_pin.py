...
def lazy_import():
    ...
    globals()['PinMeta'] = PinMeta


class PinStatusPin(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cid, *args, **kwargs):  # noqa: E501
        """PinStatusPin - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): Optional name for pinned data; can be used for lookups later. [optional]  # noqa: E501
            origins (Origins): [optional]  # noqa: E501
            meta (PinMeta): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, cid, *args, **kwargs):  # noqa: E501
        """PinStatusPin - a model defined in OpenAPI
