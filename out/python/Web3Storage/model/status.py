...
class Status(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cid (str): Self-describing content-addressed identifiers for distributed systems. Check the [CID (Content IDentifier) Specification](https://github.com/multiformats/cid) for more info.. [optional]  # noqa: E501
            dag_size (float): Total size of the DAG in bytes.. [optional] if omitted the server will use the default value of 132614  # noqa: E501
