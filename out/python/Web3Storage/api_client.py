...
from Web3Storage import rest
from Web3Storage.configuration import Configuration
from Web3Storage.exceptions import ApiTypeError, ApiValueError, ApiException
from Web3Storage.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = Web3StorageHTTPAPIApi()
        api_instance.delete_pins_requestid  # this is an instance of the class Endpoint
        api_instance.delete_pins_requestid()  # this invokes api_instance.delete_pins_requestid.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_pins_requestid.callable or self.callable in this class
