...
namespace Web3.Storage.Model
{
    ...
    /// Pin object
    /// </summary>
    [DataContract(Name = "PSAPin")]
    public partial class PSAPin : IEquatable<PSAPin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PSAPin" /> class.
        /// </summary>
        ...
        public PSAPin(string cid = default(string), string name = default(string), List<string> origins = default(List<string>), Dictionary<string, string> meta = default(Dictionary<string, string>))
        {
            // to ensure "cid" is required (not null)
            this.Cid = cid ?? throw new ArgumentNullException("cid is a required property for PSAPin and cannot be null");
            this.Name = name;
        ...
        {
            return this.Equals(input as PSAPin);
        }

        /// <summary>
        /// Returns true if PSAPin instances are equal
        /// </summary>
        /// <param name="input">Instance of PSAPin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PSAPin input)
        {
            if (input == null)
                return false;
