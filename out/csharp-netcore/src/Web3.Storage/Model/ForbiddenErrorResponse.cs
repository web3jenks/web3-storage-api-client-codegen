...
namespace Web3.Storage.Model
{
    ...
    public partial class ForbiddenErrorResponse : IEquatable<ForbiddenErrorResponse>, IValidatableObject
    {
        ...
        {
            /// <summary>
            /// Enum TokenIsNotValid for value: Token is not valid
            /// </summary>
            [EnumMember(Value = "Token is not valid")]
            TokenIsNotValid = 1,

            /// <summary>
            /// Enum SessionExpired for value: Session expired
            /// </summary>
        ...
        public ForbiddenErrorResponse(string name = "HTTP Error", MessageEnum? message = default(MessageEnum?))
        {
