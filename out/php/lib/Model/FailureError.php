...
/**
 * FailureError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FailureError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Failure_error';
     ...
     * Sets reason
     *
     * @param string $reason Mandatory string identifying the type of error
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param string|null $details Optional, longer description of the error; may include UUID of transaction for support, links to documentation etc
     *
     * @return self
     */
