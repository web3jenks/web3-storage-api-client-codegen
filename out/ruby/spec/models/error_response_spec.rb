...
# Unit tests for Web3Storage::ErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::ErrorResponse do
  let(:instance) { Web3Storage::ErrorResponse.new }

  describe 'test an instance of ErrorResponse' do
    it 'should create an instance of ErrorResponse' do
      expect(instance).to be_instance_of(Web3Storage::ErrorResponse)
    end
  end
