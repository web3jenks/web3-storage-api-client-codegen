...
# Unit tests for Web3Storage::Failure
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::Failure do
  let(:instance) { Web3Storage::Failure.new }

  describe 'test an instance of Failure' do
    it 'should create an instance of Failure' do
      expect(instance).to be_instance_of(Web3Storage::Failure)
    end
  end
