...
# Unit tests for Web3Storage::UploadResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::UploadResponse do
  let(:instance) { Web3Storage::UploadResponse.new }

  describe 'test an instance of UploadResponse' do
    it 'should create an instance of UploadResponse' do
      expect(instance).to be_instance_of(Web3Storage::UploadResponse)
    end
  end
