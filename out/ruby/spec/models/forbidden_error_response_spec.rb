...
# Unit tests for Web3Storage::ForbiddenErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::ForbiddenErrorResponse do
  let(:instance) { Web3Storage::ForbiddenErrorResponse.new }

  describe 'test an instance of ForbiddenErrorResponse' do
    it 'should create an instance of ForbiddenErrorResponse' do
      expect(instance).to be_instance_of(Web3Storage::ForbiddenErrorResponse)
    end
  end
