...
# Unit tests for Web3Storage::TextMatchingStrategy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::TextMatchingStrategy do
  let(:instance) { Web3Storage::TextMatchingStrategy.new }

  describe 'test an instance of TextMatchingStrategy' do
    it 'should create an instance of TextMatchingStrategy' do
      expect(instance).to be_instance_of(Web3Storage::TextMatchingStrategy)
    end
  end
end
