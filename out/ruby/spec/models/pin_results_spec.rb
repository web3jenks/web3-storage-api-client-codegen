...
# Unit tests for Web3Storage::PinResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::PinResults do
  let(:instance) { Web3Storage::PinResults.new }

  describe 'test an instance of PinResults' do
    it 'should create an instance of PinResults' do
      expect(instance).to be_instance_of(Web3Storage::PinResults)
    end
  end
