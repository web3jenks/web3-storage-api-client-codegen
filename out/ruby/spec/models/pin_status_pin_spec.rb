...
# Unit tests for Web3Storage::PinStatusPin
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::PinStatusPin do
  let(:instance) { Web3Storage::PinStatusPin.new }

  describe 'test an instance of PinStatusPin' do
    it 'should create an instance of PinStatusPin' do
      expect(instance).to be_instance_of(Web3Storage::PinStatusPin)
    end
  end
