...
# Unit tests for Web3Storage::PinStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::PinStatus do
  let(:instance) { Web3Storage::PinStatus.new }

  describe 'test an instance of PinStatus' do
    it 'should create an instance of PinStatus' do
      expect(instance).to be_instance_of(Web3Storage::PinStatus)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["queued", "pinning", "pinned", "failed"])
