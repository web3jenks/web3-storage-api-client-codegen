...
# Unit tests for Web3Storage::PSAPin
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::PSAPin do
  let(:instance) { Web3Storage::PSAPin.new }

  describe 'test an instance of PSAPin' do
    it 'should create an instance of PSAPin' do
      expect(instance).to be_instance_of(Web3Storage::PSAPin)
    end
  end
