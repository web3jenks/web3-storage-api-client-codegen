...
# Unit tests for Web3Storage::FailureError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::FailureError do
  let(:instance) { Web3Storage::FailureError.new }

  describe 'test an instance of FailureError' do
    it 'should create an instance of FailureError' do
      expect(instance).to be_instance_of(Web3Storage::FailureError)
    end
  end
