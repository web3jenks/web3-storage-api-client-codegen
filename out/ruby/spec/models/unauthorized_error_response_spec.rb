...
# Unit tests for Web3Storage::UnauthorizedErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::UnauthorizedErrorResponse do
  let(:instance) { Web3Storage::UnauthorizedErrorResponse.new }

  describe 'test an instance of UnauthorizedErrorResponse' do
    it 'should create an instance of UnauthorizedErrorResponse' do
      expect(instance).to be_instance_of(Web3Storage::UnauthorizedErrorResponse)
    end
  end
