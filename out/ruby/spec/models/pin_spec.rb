...
# Unit tests for Web3Storage::Pin
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Web3Storage::Pin do
  let(:instance) { Web3Storage::Pin.new }

  describe 'test an instance of Pin' do
    it 'should create an instance of Pin' do
      expect(instance).to be_instance_of(Web3Storage::Pin)
    end
  end
  ...
  describe 'test attribute "peer_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PinQueued", "Pinning", "Pinned"])
